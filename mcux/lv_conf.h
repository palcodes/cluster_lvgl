/*
 * lv_conf.h - RGB565 preview of what the panel shows
 *
 * LVGL 9.4, from the SDK's own lv_conf_template.h with the changes below.
 * The MCUXpresso project does NOT use this file: there the config is
 * generated from Kconfig into source/mcux_config.h and source/lv_conf.h.
 * See mcux/README.md - shipping a second lv_conf.h into that project would
 * shadow the generated one, because it builds with LV_CONF_INCLUDE_SIMPLE.
 *
 * Changes from the template:
 *   LV_COLOR_DEPTH 16 - matches the panel's RGB565 framebuffer
 *   LV_MEM_SIZE 192 KB
 *   LV_FONT_MONTSERRAT_14 off, LV_FONT_DEFAULT = cl_font_semi_14
 *   LV_DEF_REFR_PERIOD 30 ms
 */
/**
 * @file lv_conf.h
...
#define LV_STDARG_INCLUDE       <stdarg.h>
    ...
    #define LV_MEM_SIZE (192 * 1024U)         /**< [bytes] - see mcux/README.md */
...
#define LV_DEF_REFR_PERIOD  30      /**< [ms] nothing animates yet */
